		...
		<div class="botonera">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
					<div class="btn btn_form btn-primary" id="actualizar_usuario" ng-click="actualizar_usuario()"  data-type="info">Actualizar</div>
				</div>
				<div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
					<a class="btn btn_form btn-danger" id="consultar_usuario"  href="/admin/users">Consultar</a>
				</div>
				<div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
