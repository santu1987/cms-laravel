...
@section('content')
<div id="section_user_consulta" ng-controller="CategoriasConsultaController">
...
@section('cuerpo_js')
    ...
    <script type="text/javascript" src="{{asset('js/angular/controladores/CategoriasConsultaController.js')}}"></script>
     <!-- Data tables -->
